...
def run_ppi(I0, alphas, alphas_prime, betas, A=None, R=None, bs=None, qm=None, rl=None,
            Imax=None, Imin=None, Bs=None, B_dict=None, G=None, T=None, frontier=None, seed=None):
    if seed is not None:
        np.random.seed(seed)
...
def compute_error(I0, IF, success_rates, alphas, alphas_prime, betas, A=None, 
    ...
    if parallel_processes is None:
        sols = np.array([run_ppi(I0=I0, alphas=alphas, alphas_prime=alphas_prime, 
                          ...
                          Bs=Bs, B_dict=B_dict, G=G, T=T, seed=itera) for itera in range(sample_size)])
...
def run_ppi_parallel(I0, alphas, alphas_prime, betas, A=None, R=None, bs=None, qm=None, rl=None,
    ...
    sols = Parallel(n_jobs=parallel_processes, verbose=0)(delayed(run_ppi)\
            (I0=I0, alphas=alphas, alphas_prime=alphas_prime, betas=betas,
             ...
             Bs=Bs, B_dict=B_dict, T=T, frontier=frontier, seed=itera) for itera in range(sample_size))
